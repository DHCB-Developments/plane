...
import { ProjectGithubRepositoriesRoot } from "@/components/integration/github/project-repositories-root";
...
function GithubProjectSettingsPage({ params }: Route.ComponentProps) {
  ...
  return (
    <SettingsContentWrapper header={<GithubProjectSettingsHeader />}>
      ...
      <ProjectGithubRepositoriesRoot workspaceSlug={workspaceSlug} projectId={projectId} />
