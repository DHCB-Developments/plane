...
import { AnalyticsCycles, AnalyticsModules } from "@/components/analytics/cycle-module-tabs";
...
export const getAnalyticsTabs = (t: (key: string, params?: Record<string, any>) => string): AnalyticsTab[] => [
  ...
  { key: "cycles", label: t("common.cycles"), content: AnalyticsCycles, isDisabled: false },
  { key: "modules", label: t("common.modules"), content: AnalyticsModules, isDisabled: false },
];
