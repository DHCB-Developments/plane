# Generated by Django 4.2.30 on 2026-07-17 01:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property_type', models.CharField(choices=[('TEXT', 'Text'), ('DECIMAL', 'Decimal'), ('OPTION', 'Option'), ('BOOLEAN', 'Boolean'), ('DATETIME', 'Datetime'), ('RELATION', 'Relation'), ('URL', 'URL')], max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value_decimal', models.DecimalField(blank=True, decimal_places=4, max_digits=19, null=True)),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(condition=models.Q(('deleted_at__isnull', True)), fields=('issue_type', 'display_name'), name='issue_property_unique_issue_type_name_when_deleted_at_null'),
        ),
        migrations.AlterUniqueTogether(
            name='issueproperty',
